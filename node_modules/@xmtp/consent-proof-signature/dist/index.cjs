 ...
 */
const createConsentProofPayload = (signature, timestampMs) => proto.invitation.ConsentProofPayload.encode({
    signature,
    timestamp: Long.fromNumber(timestampMs),
    payloadVersion: proto.invitation.ConsentProofPayloadVersion.CONSENT_PROOF_PAYLOAD_VERSION_1,
}).finish();

exports.createConsentMessage = createConsentMessage;
exports.createConsentProofPayload = createConsentProofPayload;
